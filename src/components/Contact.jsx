  ...
  return (
    <section id="contact" className="py-32 px-6 border-t border-white/5">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          <h2 className="text-6xl md:text-9xl font-black mb-10 tracking-tighter uppercase leading-[0.8]">
            Let's<br />
            <span className="text-[var(--accent)]">Talk.</span>
          </h2>
          <p className="max-w-xl mx-auto text-xl text-[var(--text-dim)] font-light mb-16 leading-relaxed text-center">
