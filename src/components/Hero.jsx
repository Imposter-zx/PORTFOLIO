  ...
  return (
    <section id="home" className="min-h-screen flex flex-col justify-center pt-20 px-6 relative overflow-hidden">
      <div className="max-w-4xl">
        ...
        >
          <span className="text-[var(--accent)] text-[var(--fs-xs)] font-mono mb-6 inline-block uppercase tracking-[0.4em]">
            Creative Developer
          </span>
          <h1 className="text-[var(--fs-huge)] font-black mb-8 leading-[0.85] tracking-tighter uppercase">
            I turn code<br />
